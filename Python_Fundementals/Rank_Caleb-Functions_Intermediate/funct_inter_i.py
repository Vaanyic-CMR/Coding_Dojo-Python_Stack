...
print('Problem 2: Iterate Through a List of Dictionaries')
...
def iterateDictionary2(key_name, l):
    for i in l:
        print(i[key_name])
...
print('Problem 4: Iterate Through a Dictionary with List Values')
def printInfo(d):
    for k in d:
        print('----------')
        print(len(d[k]), k.upper())
        for i in d[k]:
            print(i)
